...
type ItemTransition interface {
	...
	Transition(ctx context.Context, src []ItemInfoWithSlot, dst []ItemInfoWithSlot, srcWindowName resources_control.WindowName, dstWindowName resources_control.WindowName) (bool, error)
