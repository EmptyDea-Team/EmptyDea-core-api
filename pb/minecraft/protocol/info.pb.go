...
type Profile struct {
	...
	NetEase       bool                   `protobuf:"varint,3,opt,name=NetEase,proto3" json:"NetEase,omitempty"`
...
func (x *Profile) GetProtocol() int32 {
	if x != nil {
		return x.Protocol
	}
	return 0
...
func (x *Profile) GetNetEase() bool {
	if x != nil {
		return x.NetEase
	}
	return false
...
const file_info_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"info.proto\x12#mousetunnel.minecraft.protocol.info\"Y\n" +
	"\aProfile\x12\x1a\n" +
...
var file_info_proto_goTypes = []any{
	(*Profile)(nil), // 0: mousetunnel.minecraft.protocol.info.Profile
}
